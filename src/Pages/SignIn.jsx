...
const SignIn = () => {
    ...
    const googleSignInBtnHandler=(e)=>{
        e.preventDefault();
            ...
            <section className='right col-span-12 md:col-span-6 flex items-center justify-center p-8 md:p-16'>
                { user? (<div className='flex flex-col gap-3 items-center justify-center'>
                    ...
                    <div className="flex flex-col gap-3">
                        <button onClick={googleSignInBtnHandler} className="btn btn-md w-full bg-white border-slate-300 text-slate-700 normal-case font-medium hover:bg-slate-50 flex items-center justify-center gap-2">
                        ...
                        <button onClick={githubBtnHandler} className="btn btn-md w-full bg-slate-900 border-slate-900 text-white normal-case font-medium hover:bg-slate-800 flex items-center justify-center gap-2">
